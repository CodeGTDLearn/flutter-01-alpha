...
import 'package:flutter_01_alpha/app/core/app_drivers/cupertino_app_driver.dart';
import 'package:flutter_01_alpha/app/core/app_drivers/material_app_driver.dart';
...
class GetByPlatform {
  ...
  StatelessWidget appDriver() {
    if ('ios' == _properties.appPlatform) return CupertinoAppDriver();
    return MaterialAppDriver();
  }
